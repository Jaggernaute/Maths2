...
\[
    ...
    \noindent\fbox{%
        On peu en deduire ce systeme possede une infinité de solutions.
    }
    \newpage
    ...
    \noindent\fbox{%
        Donc $\vec{x_1} + \vec{x_2}$ est une solution de ce systeme.
    }
    ...
    \noindent\fbox{%
        Donc $k\vec{x}$ est une solution de ce systeme.
    }
    \newpage
